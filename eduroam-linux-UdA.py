...
Messages.cat_dir_exists = "Le répertoire {} existe ; certains de ses " \
    "fichiers peuvent être écrasés"
Config.instname = "Université d'Angers"
Config.profilename = ""
Config.url = "http://www.univ-angers.fr/wifihd"
Config.email = "votre support local eduroam®"
Config.title = "eduroam CAT"
Config.server_match = "univ-angers.fr"
...
Config.init_confirmation = "Cet installateur ne fonctionnera " \
    ...
    "{1}."
Config.user_realm = "univ-angers.fr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:rad01.univ-angers.fr', 'DNS:rad02.univ-angers.fr', 'DNS:radius.univ-angers.fr', 'DNS:radiusqual.univ-angers.fr', 'DNS:repradius.univ-angers.fr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonyme@univ-angers.fr"
