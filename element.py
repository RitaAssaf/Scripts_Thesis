...
#try the If logic compiled xml
[ If ( liking [ alice ][ 1 ]==0 , Then = liking [ sascha ][ 1 ]==1)  ] ,

#try the If logic combined with in compiled xml
[ If ( liking [ alice ][ 1 ] in {0,1} , Then = (liking [ sascha ][ 1 ] in {0,1}))  ] ,


#try the If logic combined with among compiled xml
[ If ( liking [ alice ][ 1 ].among(set1)  , Then = (liking [ sascha ][ 1 ].among(set1) ))  ] ,
