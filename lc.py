...
from ilf2 import run_with_timeout,get_label,hopcroft, build_partial_order_3, build_partial_order_4,hopcroft_multiset,dir_ILF, ILF
...
if __name__ == '__main__':
	...
	ilf_reached_timeout= False
	if ilf:
		node_dict,iterations,  time_used, mem_used = run_with_timeout(7200 , ILF, Gp, Gt) #timeout 2 hrs
	...
	if ilf_reached_timeout:
		...
		compile()  # generates lc.xml by default

		xml_filename = f"lc_{pattern}_{target}_{timestamp}.xml"

		
		shutil.move("lc.xml", xml_filename)
