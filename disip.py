...
if __name__ == '__main__':
	...
	#python disip.py --pattern ladder  --target gt-06122025092950 --ilf --ordre --typage --output "/home/etud/Bureau/projet/indicators_lines_cols/"
	...
	if ilf:
		node_dict,iterations,  time_used, mem_used = run_with_timeout(3600 , dir_ILF, Gp, Gt)
...
###solve#####################################################################################
		...
		xml_filename = f"disip_{pattern}_{target_save}_{timestamp}.xml"

		
		shutil.move("disip.xml", xml_filename)
		...
		if os.path.exists(xml_filename):
			...
			print("Error: disip1.xml file not generated. Check your model definition.")
